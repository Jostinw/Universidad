...
public class FrmCenso extends javax.swing.JDialog {
    ...
    private void buscar() {
        ...
        String metodo = cbxMetodoBusqueda.getSelectedItem().toString().toLowerCase();
        String atributo = cbxAtributoBusqueda.getSelectedItem().toString().toLowerCase();
        ...
        modelo.setCensos(cc.buscar(elemento, metodo, atributo));
    ...
    private void initComponents() {
        ...
        cbxMetodoBusqueda.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Binaria", "Lineal" }));

        cbxAtributoBusqueda.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nombre", "Motivo", "Estado", "Fecha" }));
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addComponent(cbxMetodoBusqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 371, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cbxAtributoBusqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel6Layout.createSequentialGroup()
